...
Para executar o jogo, basta dar um duplo clique no executável de nome “main”, que está na pasta compactada WAR.zip. Precisamos compactar a pasta desse jeito para ter acesso aos arquivos do código.
